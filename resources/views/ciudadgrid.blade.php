                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="4"><label> Departamento</label></a></li>
                        </ul>
                    </div>
                    <table id="tciudad" name="tciudad" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                 <a href="ciudad/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tciudad').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
         "ajax": "{!! URL::to ('/datosCiudad?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#tciudad tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tciudad thead th').eq( $(this).index() ).text();
