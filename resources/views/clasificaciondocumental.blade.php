...
function datosSelect(ids,abrev)
{
  ...
  document.getElementById('abreviatura'+document.getElementById('campo').value+'ClasificacionDocumental'+document.getElementById('registro').value).value=abrev;
    ...
    $(document).ready(function(){ 
      ...
      clasificaciondocumental.estilo   = ['','width: 200px;height:35px;','width: 200px;height:35px;','width: 200px;height:35px;','width: 200px;height:35px;','width: 200px;height:35px;','width: 100px;height:35px;','width: 150px;height:35px;'];
            ...
            <div class="col-sm-12">
              <div class="row show-grid">
               ...
               <div class="pestana">Clasificaci&oacute;n documental</div>
                <div class="col-md-1" style="width: 40px;" onclick="clasificaciondocumental.agregarCampos(valorClasificacionDocumental,'A')">
                  <span class="glyphicon glyphicon-plus"></span>
                </div>
                <div class="col-md-1" style="width: 200px;">Dependencia</div>
                <div class="col-md-1" style="width: 200px;">Sub Dependencia</div>
                ...
                <div class="col-md-1" style="width: 150px;">Estado</div>
