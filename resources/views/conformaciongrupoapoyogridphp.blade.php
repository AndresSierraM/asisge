...
$grid->SelectCommand = 'SELECT idConformacionGrupoApoyo, GA.nombreGrupoApoyo, nombreConformacionGrupoApoyo,fechaConformacionGrupoApoyo
...
$grid->setUrl('conformaciongrupoapoyogrid');
// SetOpciones de la grid
$grid->setGridOptions(array(
    "rowNum"=>30,
    "rowList"=>array(30,50,100),
    "sortname"=>"nombreConformacionGrupoApoyo",
    "multiSort"=>true,
    "sortable"=>true,
    "altRows"=>true,
    "hoverrows"=>true,
...
// ----------------------------------------------------
$grid->setColProperty("idConformacionGrupoApoyo", array(
...
$grid->setColProperty("nombreGrupoApoyo", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Grupo Apoyo"
    )
);
$grid->setColProperty("nombreConformacionGrupoApoyo", array(
  "searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
  "label"=>"Nombre"
    )
);
$grid->setColProperty("fechaConformacionGrupoApoyo", array(
  "searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
  "label"=>"Fecha"
    )
);
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'conformaciongrupoapoyo/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'conformaciongrupoapoyo/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'conformaciongrupoapoyo/'+id+'/edit?accion=eliminar';
        } else {
