        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="tcompetencia" name="tcompetencia" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-primary active">
                                <th style="width:70px;padding: 1px 8px;" data-orderable="false">
                                 <a href="competencia/create"><span style= "color:white; display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tcompetencia').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosCompetencia?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#tcompetencia tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tcompetencia thead th').eq( $(this).index() ).text();
