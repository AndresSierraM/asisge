...
$grid->SelectCommand = 'SELECT idPrograma, nombrePrograma, fechaElaboracionPrograma,
                                nombreClasificacionRiesgo
                        FROM programa P
                        left join clasificacionriesgo CR
                        on P.ClasificacionRiesgo_idClasificacionRiesgo = CR.idClasificacionRiesgo';
...
$grid->setColProperty("idPrograma", array(
...
$grid->setColProperty("nombrePrograma", array(
	"searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
	"label"=>"Programa"
    )
);

$grid->setColProperty("fechaElaboracionPrograma", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "formatter"=>"date",
  "label"=>"Fecha"
    )
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'programa/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'programa/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'programa/'+id+'/edit?accion=eliminar';
        } else {
