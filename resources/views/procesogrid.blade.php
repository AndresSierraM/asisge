                    ...
                    <table id="tproceso" name="tproceso" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                ...
                                {!!Html::link('proceso/create','',array('class' => 'glyphicon glyphicon-plus'))!!}
...
<script type="text/javascript">
    ...
    $('#tproceso tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tproceso thead th').eq( $(this).index() ).text();
