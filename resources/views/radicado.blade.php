                    ...
                    <div class="input-group"">
                     <div class="container">
                      <div class="dropzone dropzone-previews" id="dropzoneFileUpload_'.$i.'_'.$nombretitulo["idDocumento"].'" >
                       ...
                       <input id="botonRadicar_'.$i.'_'.$nombretitulo['idDocumento'].'" type="button" value="Radicar" class="btn btn-primary" onclick="limpiarDivPreview(); Radicar(\'\', this.id); irArriba();">
                    </div>
                  </div>
                </div>
            </div>
...
<!--Campos de la pestaña clasificacion-->
        ...
        <div class="form-group" id='test'>
          {!!Form::label('ubicacionEstanteRadicado', 'Ubicación', array('class' => 'col-sm-2 control-label'))!!}
          <div class="col-sm-10">
              <div class="input-group">
                <span class="input-group-addon">
