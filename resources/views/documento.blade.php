...
<script>
    ...
    $(document).ready(function(){
      ...
      protRol.campos   = ['idDocumentoPermiso','Rol_idRol','nombreRolPermiso', 'cargarDocumentoPermiso', 'descargarDocumentoPermiso','consultarDocumentoPermiso','modificarDocumentoPermiso','imprimirDocumentoPermiso','correoDocumentoPermiso','eliminarDocumentoPermiso'];
      protRol.etiqueta = ['input','input','input', 'checkbox','checkbox','checkbox','checkbox','checkbox','checkbox','checkbox'];
      protRol.tipo     = ['hidden','hidden','text', 'checkbox','checkbox','checkbox','checkbox','checkbox','checkbox','checkbox'];
      protRol.estilo   = ['','','width: 300px;height:35px', stilocheck, stilocheck, stilocheck, stilocheck, stilocheck, stilocheck, stilocheck];
      protRol.clase    = ['','','','','','','','','',''];
...
?>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      protCompania.campoid = 'idDocumentoPermisoCompania';
      protCompania.campoEliminacion = 'eliminarDocumentoPermisoCompania';

      protCompania.campos   = ['idDocumentoPermisoCompania', 'Compania_idCompania', 'nombrePermisoCompania'];
      ...
      {
        protCompania.agregarCampos(JSON.stringify(documentopermisocompania[j]),'L');
      }
...
<!-- {!!Html::script('js/documentoversion.js')!!} -->
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      version.estilo   = ['','width: 100px;height:35px;','width: 250px;height:35px;','width: 180px;height:35px;','width: 180px;height:35px;','width: 180px;height:35px;'];
      version.clase    = ['','','','','',''];
              ...
              <div class="panel-body">
                <div class="panel-group" id="accordion">
                              ...
                              <div class="form-group" id='test'>
                                <div class="col-sm-12">
                                  <div class="row show-grid">
                                    ...
                                    <div class="col-md-1" style="width: 250px;">Tipo</div>
                                    <div class="col-md-1" style="width: 180px;">Longitud</div>
                                    <div class="col-md-1" style="width: 180px;">Inicio</div>
                                    <div class="col-md-1" style="width: 180px;">Relleno</div>
                  ...
                  <div class="panel panel-info">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#protRol">Permisos</a>
                      </h4>
                    </div>
                    <div id="protRol" class="panel-collapse collapse">
                      <div class="panel-body">
                                    ...
                                    <div class="form-group" id='test'>
                                      <div class="col-sm-12">
                                        <div class="row show-grid" style=" border: 1px solid #C0C0C0;">
                                          ...
                                          <div class="col-md-1" style="width: 300px;">Rol</div>
