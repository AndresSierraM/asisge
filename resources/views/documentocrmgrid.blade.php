                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="4"><label> Numeración</label></a></li>
                    ...
                    <table id="tdocumentocrm" name="tdocumentocrm" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                ...
                                {!!Html::link('documentocrm/create','',array('class' => 'glyphicon glyphicon-plus'))!!}
                                 <a href="#"><span class="glyphicon glyphicon-refresh"></span></a>
                                </th>
                                <th><b>ID</b></th>
                                <th><b>Código</b></th>
                                <th><b>Nombre</b></th>
                                <th><b>Numeración</b></th>
                                <th><b>Longitud</b></th>
                                <th><b>Desde</b></th>
                                <th><b>Hasta</b></th>
                            </tr>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#tdocumentocrm').DataTable({
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosDocumentoCRM')!!}",
        });*/
        var lastIdx = null;
        var table = $('#tdocumentocrm').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
    ...
    $('#tdocumentocrm tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tdocumentocrm thead th').eq( $(this).index() ).text();
