                    ...
                    <table id="tpresupuesto" name="tpresupuesto" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                ...
                                <a href="presupuesto/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tpresupuesto').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
          "ajax": "{!! URL::to ('/datosPresupuesto?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#tpresupuesto tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tpresupuesto thead th').eq( $(this).index() ).text();
