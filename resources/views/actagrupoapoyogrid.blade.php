                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="3"><label> Fecha Reunión</label></a></li>
...
<div id="modalActaGrupoApoyo" class="modal fade" role="dialog">
         ...
         <div class="container">
            <div class="row">
                <div class="container col-md-9 col-sm-12">
                    ...
                    <table id="tactagrupoapoyoselect" name="tactagrupoapoyoselect" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th><b>Nombre</b></th>
                            </tr>
