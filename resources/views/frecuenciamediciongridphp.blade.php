...
$grid->SelectCommand = 'SELECT idFrecuenciaMedicion, codigoFrecuenciaMedicion, nombreFrecuenciaMedicion, valorFrecuenciaMedicion, unidadFrecuenciaMedicion  FROM frecuenciamedicion';
...
$grid->setColProperty("idFrecuenciaMedicion", array(
...
$grid->setColProperty("codigoFrecuenciaMedicion", array(
	"searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
	"label"=>"C&oacute;digo"
    )
);

$grid->setColProperty("nombreFrecuenciaMedicion", array(
	"searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
	"label"=>"Nombre"
    )
);

$grid->setColProperty("valorFrecuenciaMedicion", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "formatter"=>"integer",
  "formatoptions"=>array("thousandsSeparator"=>","),
  "label"=>"Valor"
...
$grid->setColProperty("unidadFrecuenciaMedicion", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Unidad"
    )
);
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'frecuenciamedicion/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'frecuenciamedicion/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'frecuenciamedicion/'+id+'/edit?accion=eliminar';
        } else {
