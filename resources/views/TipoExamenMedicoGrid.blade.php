                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="3"><label> Lim. Inferior</label></a></li>
                        ...
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                 <a href="tipoexamenmedico/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
                                 <a href="#"><span class="glyphicon glyphicon-refresh"></span></a>
                                </th>
                                <th><b>ID</b></th>
                                <th><b>Nombre</b></th>
                                <th><b>Lim. Inferior</b></th>
                                <th><b>Lim Superior</b></th>
                            </tr>
                        </thead>
                                        <tfoot>
                            <tr class="btn-default active">
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#ttipoexamenmedico').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTipoExamenMedico?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
