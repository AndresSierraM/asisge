        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="tmanualgestion" name="tmanualgestion" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:70px;padding: 1px 8px;" data-orderable="false">
                                 <a href="manualgestion/create"><span style= " display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
   function imprimirFormato(id)
    ...
    $(document).ready( function () {
        ...
        var table = $('#tmanualgestion').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosManualGestion?modificar="+modificar+"&eliminar="+eliminar+"&imprimir="+imprimir+"')!!}",
            "language": {
    ...
    $('#tmanualgestion tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tmanualgestion thead th').eq( $(this).index() ).text();
