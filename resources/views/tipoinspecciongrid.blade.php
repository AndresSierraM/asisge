...
@section('titulo')<h3 id="titulo"><center>Tipo de Inspección</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#ttipoinspeccion').DataTable({
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTipoInspeccion')!!}",
        });*/
        var lastIdx = null;
        var modificar = '<?php echo (isset($datos[0]) ? $dato["modificarRolOpcion"] : 0);?>';
        var eliminar = '<?php echo (isset($datos[0]) ? $dato["eliminarRolOpcion"] : 0);?>';
        var table = $('#ttipoinspeccion').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTipoInspeccion?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#ttipoinspeccion tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#ttipoinspeccion thead th').eq( $(this).index() ).text();
