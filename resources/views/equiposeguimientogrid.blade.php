...
@section('titulo')<h3 id="titulo"><center>Equipos de seguimiento y medici&#243;n</center></h3>@stop
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="equiposeguimiento" name="equiposeguimiento" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:55px;padding: 1px 8px;" data-orderable="false">
                                 <a href="equiposeguimiento/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#equiposeguimiento').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosEquipoSeguimiento?modificar="+modificar+"&eliminar="+eliminar+"&imprimir="+imprimir+"')!!}",
            "language": {
    ...
    $('#equiposeguimiento tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#equiposeguimiento thead th').eq( $(this).index() ).text();
