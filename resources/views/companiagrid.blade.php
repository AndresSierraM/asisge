...
@section('titulo')<h3 id="titulo"><center>Compañías</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="tcompania" name="tcompania" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                 <a href="compañia/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $('#tcompania tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tcompania thead th').eq( $(this).index() ).text();
