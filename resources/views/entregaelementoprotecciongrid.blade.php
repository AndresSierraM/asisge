                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="2"><label> Elemento</label></a></li>
                            <li><a class="toggle-vis" data-column="3"><label> Fecha de Entrega</label></a></li>
                        </ul>
                    </div>
                    <table id="tentregaelemento" name="tentregaelemento" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:90px;padding: 1px 8px;" data-orderable="false">
                                 <a href="entregaelementoproteccion/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
  function imprimirFormato(id)
    ...
    function imprimirFormato(id)
    {
        window.open('entregaelementoproteccion/'+id+'?accion=imprimir','entregaelementoproteccion','width=5000,height=5000,scrollbars=yes, status=0, toolbar=0, location=0, menubar=0, directories=0');
    }
    ...
    $(document).ready( function () {
        ...
        /*$('#tentregaelemento').DataTable({
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosEntregaElementoProteccion')!!}",
        });*/
        var lastIdx = null;
        var modificar = '<?php echo (isset($datos[0]) ? $dato["modificarRolOpcion"] : 0);?>';
        var eliminar = '<?php echo (isset($datos[0]) ? $dato["eliminarRolOpcion"] : 0);?>';
        var imprimir = '<?php echo (isset($datos[0]) ? $dato["consultarRolOpcion"] : 0);?>';
        var table = $('#tentregaelemento').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosEntregaElementoProteccion?modificar="+modificar+"&eliminar="+eliminar+"&imprimir="+imprimir+"')!!}",
            "language": {
    ...
    $('#tentregaelemento tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tentregaelemento thead th').eq( $(this).index() ).text();
...
<div id="modalEntregaElemento" class="modal fade" role="dialog">
         ...
         <div class="container">
            <div class="row">
                <div class="container col-md-9 col-sm-12">
                    ...
                    <table id="tentregaelementoselect" name="tentregaelementoselect" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th><b>Nombre</b></th>
                            </tr>
