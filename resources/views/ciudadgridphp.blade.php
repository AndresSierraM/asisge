...
// Write the SQL Query
$grid->SelectCommand = 'SELECT idCiudad, codigoCiudad, nombreCiudad, D.nombreDepartamento 
                        FROM Ciudad C
...
$grid->setUrl('ciudadgrid');
// Set some grid options
$grid->setGridOptions(array(
    "caption"=>"Ciudad",
    "rowNum"=>30,
    "rowList"=>array(30,50,100),
    "sortname"=>"nombreCiudad",
    "multiSort"=>true,
    "sortable"=>true,
    "altRows"=>true,
    "hoverrows"=>true,
...
$grid->setColProperty("idCiudad", array(
...
$grid->setColProperty("codigoCiudad", array(
  "searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
  "label"=>"C&oacute;digo"
    )
);

$grid->setColProperty("nombreCiudad", array(
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'ciudad/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'ciudad/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'ciudad/'+id+'/edit?accion=eliminar';
        } else {
