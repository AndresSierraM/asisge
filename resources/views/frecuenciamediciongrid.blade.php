...
@section('titulo')<h3 id="titulo"><center>Frecuencias de Medición</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="5"><label> Unidad</label></a></li>
                        </ul>
                    </div>
                        ...
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                 <a href="frecuenciamedicion/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tfrecuenciamedicion').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosFrecuenciaMedicion?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
