...
$grid->SelectCommand = 'SELECT idOpcion, ordenOpcion, nombreOpcion, rutaOpcion, iconoOpcion, nombrePaquete
                        FROM opcion
                        LEFT JOIN  paquete
...
$grid->setColProperty("ordenOpcion", array(
...
$grid->setColProperty("rutaOpcion", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Ruta"
    )
);

$grid->setColProperty("iconoOpcion", array(
