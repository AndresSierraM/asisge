...
@section('titulo')<h3 id="titulo"><center>Elementos de Protecci&oacute;n</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                        ...
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                 <a href="elementoproteccion/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#telementoproteccion').DataTable({
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosElementoProteccion')!!}",
        });*/
        var lastIdx = null;
        var modificar = '<?php echo (isset($datos[0]) ? $dato["modificarRolOpcion"] : 0);?>';
        var eliminar = '<?php echo (isset($datos[0]) ? $dato["eliminarRolOpcion"] : 0);?>';
        var table = $('#telementoproteccion').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosElementoProteccion?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#telementoproteccion tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#telementoproteccion thead th').eq( $(this).index() ).text();
