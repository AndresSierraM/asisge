...
@section('titulo')<h3 id="titulo"><center>Acta Capacitación</center></h3>@stop
@section('content')
                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="4"><label> Plan Capacitación</label></a></li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    ...
    $('#tactacapacitacion tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tactacapacitacion thead th').eq( $(this).index() ).text();
...
<div id="modalActaCapacitacion" class="modal fade" role="dialog">
        ...
        <a class='cerrar' href='javascript:void(0);' onclick='cerrarDivFirma(); document.getElementById(&apos;signature-pad&apos;).style.display = &apos;none&apos;'>x</a> 
            ...
            <div class="m-signature-pad--footer">
              ...
              <button type="button" class="button save btn btn-success"  onclick="actualizarFirma()">Guardar Firma</button>
                ...
                {!!Form::hidden('idActa', null, array('id' => 'idActa'))!!}
         ...
         <div class="container">
            <div class="row">
                <div class="container col-md-9 col-sm-12">
                    ...
                    <table id="tactacapacitacionselect" name="tactacapacitacionselect" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th><b>Nombre</b></th>
                            </tr>
