...
$grid->SelectCommand = 'SELECT idTipoInspeccion, codigoTipoInspeccion, nombreTipoInspeccion, nombreFrecuenciaMedicion
...
$grid->setUrl('tipoinspecciongrid');
// SetOpciones de la grid
$grid->setGridOptions(array(
    "rowNum"=>30,
    "rowList"=>array(30,50,100),
    "sortname"=>"codigoTipoInspeccion",
    "multiSort"=>true,
    "sortable"=>true,
    "altRows"=>true,
    "hoverrows"=>true,
...
// ----------------------------------------------------
$grid->setColProperty("idTipoInspeccion", array(
...
$grid->setColProperty("codigoTipoInspeccion", array(
...
$grid->setColProperty("nombreFrecuenciaMedicion", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Frecuencia de Medici&oacute;n"
    )
);
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'tipoinspeccion/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'tipoinspeccion/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'tipoinspeccion/'+id+'/edit?accion=eliminar';
        } else {
