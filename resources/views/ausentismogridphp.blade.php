...
$grid->SelectCommand = 'SELECT idAusentismo, nombreCompletoTercero, fechaElaboracionAusentismo, tipoAusentismo, 
                              fechaInicioAusentismo, fechaFinAusentismo
                        FROM ausentismo E
                        left join tercero T
                        on E.Tercero_idTercero = T.idTercero';
...
$grid->setUrl('ausentismogrid');
// SetOpciones de la grid
$grid->setGridOptions(array(
    "rowNum"=>30,
    "rowList"=>array(30,50,100),
    "sortname"=>"fechaElaboracionAusentismo",
    "multiSort"=>true,
    "sortable"=>true,
    "altRows"=>true,
    "hoverrows"=>true,
...
$grid->setColProperty("idAusentismo", array(
...
$grid->setColProperty("fechaElaboracionAusentismo", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "formatter"=>"date",
  "label"=>"Elaboraci&oacute;n"
    )
);
$grid->setColProperty("tipoAusentismo", array(
	"searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
	"label"=>"Tipo Ausencia"
    )
);

$grid->setColProperty("fechaInicioAusentismo", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "formatter"=>"datetime",
  "label"=>"Desde"
    )
...
$grid->setColProperty("fechaFinAusentismo", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "formatter"=>"datetime",
  "label"=>"Hasta"
    )
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'ausentismo/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'ausentismo/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'ausentismo/'+id+'/edit?accion=eliminar';
        } else {
