...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#ttiponormalegal').DataTable({
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTipoNormaLegal')!!}",
        });*/
        var lastIdx = null;
        var modificar = '<?php echo $dato["modificarRolOpcion"];?>';
        var eliminar = '<?php echo $dato["eliminarRolOpcion"];?>';
        var table = $('#ttiponormalegal').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTipoNormaLegal?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#ttiponormalegal tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#ttiponormalegal thead th').eq( $(this).index() ).text();
