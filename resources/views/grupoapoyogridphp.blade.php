...
$grid->SelectCommand = 'SELECT idGrupoApoyo, codigoGrupoApoyo, nombreGrupoApoyo
                        FROM grupoapoyo';
...
$grid->setUrl('grupoapoyogrid');
// SetOpciones de la grid
$grid->setGridOptions(array(
    "rowNum"=>30,
    "rowList"=>array(30,50,100),
    "sortname"=>"codigoGrupoApoyo",
    "multiSort"=>true,
    "sortable"=>true,
    "altRows"=>true,
    "hoverrows"=>true,
...
// ----------------------------------------------------
$grid->setColProperty("idGrupoApoyo", array(
...
$grid->setColProperty("codigoGrupoApoyo", array(
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'grupoapoyo/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'grupoapoyo/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'grupoapoyo/'+id+'/edit?accion=eliminar';
        } else {
