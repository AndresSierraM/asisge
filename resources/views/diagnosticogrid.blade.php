...
@section('titulo')<h3 id="titulo"><center>Diagnósticos Generales</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tdiagnostico').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosDiagnostico?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
                        ...
                        "sInfoFiltered":   "(filtrado de un total de _MAX_ regis tros)",
                        "sInfoPostFix":    "",
                        "sSearch":         "Buscar:",
                        "sUrl":            "",
                        "sInfoThousands":  ",",
