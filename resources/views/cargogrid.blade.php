...
@section('titulo')<h3 id="titulo"><center>Cargo</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                ...
                <div class="container">
                    ...
                    <div class="btn-group" style="margin-left: 94%;margin-bottom:4px" title="Columns">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="4"><label> Salario Base </label></a></li>
                        </ul>
                    </div>
...
function imprimirCargo(id)
    ...
    $(document).ready( function () {
        ...
        var table = $('#tcargo').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosCargo?modificar="+modificar+"&eliminar="+eliminar+"&imprimir="+imprimir+"')!!}",
            "language": {
    ...
    $('#tcargo tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tcargo thead th').eq( $(this).index() ).text();
