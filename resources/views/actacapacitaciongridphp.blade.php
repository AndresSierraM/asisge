...
$grid->SelectCommand = 'SELECT idActaCapacitacion, numeroActaCapacitacion, fechaElaboracionActaCapacitacion, PC.nombrePlanCapacitacion
...
$grid->setGridOptions(array(
    ...
    "sortname"=>"numeroActaCapacitacion",
    "multiSort"=>true,
    "sortable"=>true,
    "altRows"=>true,
    "hoverrows"=>true,
...
// ----------------------------------------------------
$grid->setColProperty("idActaCapacitacion", array(
...
$grid->setColProperty("numeroActaCapacitacion", array(
  "searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
  "label"=>"N&uacute;mero"
    )
);
$grid->setColProperty("fechaElaboracionActaCapacitacion", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Fecha"
    )
);
$grid->setColProperty("nombrePlanCapacitacion", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Plan Capacitaci&oacute;n"
    )
);
// Formatos de fecha
...
$buttonadicionar = array("#pager",
    array("caption"=>"Adicionar", "title"=>"Adicionar un nuevo registro", "onClickButton"=>"js: function(){
        window.location.href = 'actacapacitacion/create'}"
    )
);
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'actacapacitacion/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'actacapacitacion/'+id+'/edit?accion=eliminar';
        } else {
