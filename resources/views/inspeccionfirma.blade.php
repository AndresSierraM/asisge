...
@section('titulo')<h3 id="titulo"><center>Inspecci&oacute;n de Seguridad Firma</center></h3>@stop

@section('content')
@include('alerts.request')


{!!Html::script('js/inspeccionfirma.js')!!}
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">							
					<div class="form-group" id='test'>
						<FONT COLOR="black">{!!Form::label('TipoInspeccion_idTipoInspeccion', 'Inspecci&oacute;n', array('class' => 'col-sm-2 control-label'))!!}</FONT>
						<div class="col-sm-10">
							<div class="input-group">
								...
								{!!Form::select('TipoInspeccion_idTipoInspeccion',$Inspeccion, (isset($inspeccion) ? $inspeccion->TipoInspeccion_idTipoInspeccion : 0),["class" => "chosen-select form-control", "placeholder" =>"Seleccione la inspecci&oacute;n"])!!}
					...
					<center>
						<div class="form-group col-md-6" id='test' >
	                  		<button class="btn btn-primary" type="button" onclick="llenarRealizadoPor($('#TipoInspeccion_idTipoInspeccion').val())" style="width: 30%;padding-left:auto;">Buscar</button>
	            		</div>	
            		</center>								                					
				</div>				
			</div>
