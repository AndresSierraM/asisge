...
@section('titulo')<h3 id="titulo"><center>Retenci&oacute;n documental</center></h3>@stop
        ...
        <div class="panel-body">
          <div class="form-group" id='test'>
            ...
            <!--   <div style="width: 1310px; display: inline-block; ">
              <div class="col-md-1" style="width: 570px;">&nbsp;</div>
              <div class="col-md-1" style="width: 150px;"><center>Retenci&oacute;n</center></div>
              <div class="col-md-1" style="width: 590px;">&nbsp;</div> -->
