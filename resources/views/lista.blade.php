...
<script>
    ...
    $(document).ready(function(){
      ...
      lista.estilo   = ['width: 200px;height:35px;','width: 300px;height:35px;', ''];
      lista.clase    = ['','', ''];
                      ...
                      <div class="form-group" id='test'>
                        <div class="col-sm-12">
                          <div class="row show-grid">
                            ...
                            <div class="col-md-1" style="width: 200px; height: 69px; ">Código <br/> <select id="select1"></select></div>
                            <div class="col-md-1" style="width: 300px; height: 69px;">Nombre <br/> <select id="select2"></select></div>
