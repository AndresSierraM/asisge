...
{!!Html::script('js/rol.js')!!}
  <script>
    ...
    $(document).ready(function(){
      ...
      permisos.campos   = ['Opcion_idOpcion',   'adicionarRolOpcion','modificarRolOpcion','eliminarRolOpcion','consultarRolOpcion','firmarRolOpcion'];
      permisos.etiqueta = ['select',          'checkbox',          'checkbox',          'checkbox',         'checkbox',     'checkbox'];
      permisos.tipo     = ['',                'checkbox',           'checkbox',          'checkbox',         'checkbox',      'checkbox'];
      permisos.estilo   = ['width: 600px;height:35px;display:inline-block;','width: 70px;height:30px;display:inline-block;','width: 70px;height:30px;display:inline-block;','width: 70px;height:30px;display:inline-block;','width: 70px;height:30px;display:inline-block;','width: 70px;height:30px;display:inline-block;'];
          ...
          <div class="form-group" id='test'>
            <div class="col-sm-12">
              <div class="row show-grid">
                ...
                <div class="col-md-1" style="width: 70px;"><center><span title="permiteFirmaOpcion" class="fa fa-pencil-square-o"></span></center></div>
