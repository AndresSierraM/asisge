...
$grid->SelectCommand = 'SELECT idUsuario, loginUsuario, nombreUsuario, correoUsuario FROM usuario';
...
$grid->setColProperty("idUsuario", array(
...
$grid->setColProperty("loginUsuario", array(
	"searchoptions"=>array("sopt"=>array("bw", "eq","ne","le","lt","ge","gt")),
	"label"=>"Usuario"
    )
);

$grid->setColProperty("nombreUsuario", array(
  "searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
  "label"=>"Nombre Completo"
    )
);

$grid->setColProperty("correoUsuario", array(
	"searchoptions"=>array("sopt"=>array("bw", "ne","le","lt","ge","gt")),
...
$buttonmodificar = array("#pager",
    array("caption"=>"Modificar", "title"=>"Modificar el registro", 
      "onClickButton"=>"js: function(){
        ...
        if(id) {
          window.location.href = 'usuario/'+id+'/edit';
        } else {
...
$buttoneliminar = array("#pager",
    array("caption"=>"Eliminar", "title"=>"Eliminar el registro", 
      "onClickButton"=>"js: function(){
        var id = $('#grid').jqGrid('getGridParam','selrow'), data={};
        if(id) {
          window.location.href = 'usuario/'+id+'/edit?accion=eliminar';
        } else {
