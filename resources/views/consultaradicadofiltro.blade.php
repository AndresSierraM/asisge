...
@section('titulo')<h3 id="titulo"><center>Consulta de raricado</center></h3>@stop
...
<script>
    ...
    $(document).ready(function(){
      ...
      documento.tipo     = [''];
      documento.estilo   = ['width: 450px;height:35px;'];
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      dependencia.tipo     = ['',];
      dependencia.estilo   = ['width: 450px;height:35px;'];
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      metadato.estilo   = ['width: 100px;height:35px;','width: 200px;height:35px;','width: 200px;height:35px;','width: 200px;height:35px;','width: 100px;height:35px;','width: 100px;height:35px;'];
      metadato.clase    = ['','','','','',''];
          ...
          <div class="form-group" id='test'>
            <div class="col-sm-12">
              <div class="row show-grid">
                ...
                <div class="col-md-1" style="width: 450px;">Documento</div>
          ...
          <div class="form-group" id='test'>
            <div class="col-sm-12">
              <div class="row show-grid">
                ...
                <div class="col-md-1" style="width: 450px;">Dependencia</div>
            ...
            <div class="form-group" id='test'>
              <div class="col-sm-12">
                <div class="row show-grid">
                  ...
                  <div class="col-md-1" style="width: 200px;">Campo</div>
                  <div class="col-md-1" style="width: 200px;">Operador</div>
