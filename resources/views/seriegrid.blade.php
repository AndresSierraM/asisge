...
@section('titulo')<h3 class="pestana" id="titulo"><center>Series</center></h3>@stop
@section('content')
<style>
    tfoot input {
                width: 100%;
                    ...
                    <table id="tserie" name="tserie" class="display table-bordered" width="100%">
                        ...
                        <tr>
                            ...
                            <tr class="btn-primary active">
                                ...
                                <a href="serie/create"><span style= "display: <?php echo $visible;?> color:white;" class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#tserie').DataTable({
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosSerie')!!}",
        });*/
        var lastIdx = null;
        var modificar = '<?php echo (isset($datos[0]) ? $dato["modificarRolOpcion"] : 0);?>';
        var eliminar = '<?php echo (isset($datos[0]) ? $dato["eliminarRolOpcion"] : 0);?>';
        var table = $('#tserie').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosSerie?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#tserie tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tserie thead th').eq( $(this).index() ).text();
