	          		...
	          		<div class="form-group">
			                ...
			                <div class="col-sm-10" ">
			                  <div class="input-group">
			                    ...
			                    {!!Form::select('CentroCosto_idCentroCosto',$centrocosto, (isset($planCapacitacion) ? $planCapacitacion->CentroCosto_idCentroCosto : 0),["class" => "select form-control", "placeholder" =>"Seleccione"])!!}                    
			                  </div>
			                </div>
		          	</div>
				<div class="form-group">
