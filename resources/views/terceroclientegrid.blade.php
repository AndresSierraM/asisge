...
?> -->
@section('titulo')<h3 id="titulo"><center> Tercero Tipo Cliente</center></h3>@stop
@section('content')
                ...
                <div class="container">
                    ...
                    <input type="hidden" id="token" value="{{csrf_token()}}"/>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="6"><label> Sector Empresa</label></a></li>
                        ...
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:60px;padding: 1px 8px;" data-orderable="false">
                                 <?php echo '<a href="tercero/create?tipoTercero='.'*03*'.'"><span style= "display:'.$visible.'" class="glyphicon glyphicon-plus"></span></a>'; ?>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        // Se crea una variable que contenga el tipo quemado 03 que es CLIENTE
        var tipoCliente = '*03*';
        var table = $('#ttercero').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTerceroCliente?modificar="+modificar+"&eliminar="+eliminar+"&tipoTercero="+tipoCliente+"')!!}",
            "language": {
