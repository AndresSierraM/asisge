        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="tzona" name="tzona" class="display table-bordered" width="100%">
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                {!!Html::link('zona/create','',array('class' => 'glyphicon glyphicon-plus'))!!}
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#tzona').DataTable({
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosZona')!!}",
        });*/
        var lastIdx = null;
        var table = $('#tzona').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
    ...
    $('#tzona tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tzona thead th').eq( $(this).index() ).text();
