...
{!!Html::script('js/accidentefirma.js')!!}
				...
				<div class="panel-body">							
					...
					<center>
						<div class="form-group col-md-6" id='test' >
	                  		<button class="btn btn-primary" type="button" onclick="llenarAccidente($('#numeroAccidente').val())" style="width: 30%;padding-left:auto;">Buscar</button>
	            		</div>	
            		</center>								                					
				</div>				
			</div>
