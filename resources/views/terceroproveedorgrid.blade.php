...
?> -->
@section('titulo')<h3 id="titulo"><center> Tercero Tipo Proveedor/Contratistas</center></h3>@stop
@section('content')
                ...
                <div class="container">
                    ...
                    <input type="hidden" id="token" value="{{csrf_token()}}"/>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a class="toggle-vis" data-column="6"><label> Tipo Proveedor</label></a></li>
                        ...
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:60px;padding: 1px 8px;" data-orderable="false">
                                 <?php echo '<a href="tercero/create?tipoTercero='.'*02*'.'"><span style= "display:'.$visible.'" class="glyphicon glyphicon-plus"></span></a>'; ?>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        // Se crea una variable que contenga el tipo quemado 02 que es PROVEEDOR/CONTRATISTAS
        var tipoProveedor = '*02*';
        var table = $('#ttercero').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosTerceroProveedor?modificar="+modificar+"&eliminar="+eliminar+"&tipoTercero="+tipoProveedor+"')!!}",
            "language": {
