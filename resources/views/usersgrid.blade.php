                        ...
                        <thead>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                 <a href="users/create"><span style= "display: <?php echo $visible;?> " class="glyphicon glyphicon-plus"></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $('#tusuario').DataTable( {
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosUsers?modificar="+modificar+"&eliminar="+eliminar+"')!!}",
            "language": {
    ...
    $('#tusuario tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tusuario thead th').eq( $(this).index() ).text();
