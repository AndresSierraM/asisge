...
class ListaChequeo extends Model
{
    ...
    protected $fillable = ['numeroListaChequeo', 'fechaElaboracionListaChequeo', 'PlanAuditoria_idPlanAuditoria', 'Proceso_idProceso', 'observacionesListaChequeo', 'Compania_idCompania'];
