...
class Cargo extends Model
{
    ...
    protected $fillable = ['codigoCargo', 'nombreCargo', 'salarioBaseCargo', 'nivelRiesgoCargo','Cargo_idDepende','aniosExperienciaCargo', 'objetivoCargo','porcentajeEducacionCargo','experienciaCargo','porcentajeExperienciaCargo','porcentajeFormacionCargo','porcentajeHabilidadCargo','porcentajeResponsabilidadCargo', 'posicionPredominanteCargo', 'restriccionesCargo', 
                    'responsabilidadesCargo', 'autoridadesCargo', 'Compania_idCompania'];
