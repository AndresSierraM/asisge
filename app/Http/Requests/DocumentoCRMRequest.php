...
class DocumentoCRMRequest extends Request
{
    ...
    public function rules()
    {
        ...
        $validacion = array(
            'codigoDocumentoCRM' => "required|string|unique:documentocrm,codigoDocumentoCRM,".$this->get('idDocumentoCRM') .",idDocumentoCRM,Compania_idCompania,".(\Session::get('idCompania')),
