...
class AuthFirmaController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    protected $redirectTo = 'accesofirma';
    protected $redirectAfterLogout = 'auth/loginfirma';
    ...
    public function getLogin()
    {
        ...
        return view('auth.loginfirma',compact('compania'));
    }
    ...
    public function postLogin(Request $request)
    {
        ...
        return redirect::to('auth/loginfirma');
