                ...
                <tr>
                    <td width="250px" style="vertical-align:top">
                        <div id="accordion" style="font-size: 12px; height: 200px; width: 240px;">
                            ...
                            <h3><a href="#">Functionality / Misc </a></h3>
                            <div>		                                 
                                <ul class="examples">
                                    <li>
                            ...
                            <div>
                                <ul class="examples">
                                    <li>
                                        <a href="searching/search_toolbar_oper/default.php" target="demoFrame">Toolbar search with operations <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
                                        <a href="searching/custom_search/default.php" target="demoFrame">Custom search form <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
                                        <a href="searching/search_dynamic/default.php" target="demoFrame">Search Upon Loading <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                 <ul class="examples">
                                    <li>
                                        <a href="editing_data/edit_template/default.php" target="demoFrame">Form Template <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
                                        <a href="editing_data/cache_dataurl/default.php" target="demoFrame">Cache dataUrl <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
                                        <a href="editing_data/timepicker/default.php" target="demoFrame">Integrate Time Picker <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
                                        <a href="editing_data/editor/default.php" target="demoFrame">Integrate HTML Editor <sup><font style="color:red">New</font></sup></a>
                                    </li>
                                    <li>
