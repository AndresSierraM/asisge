<?php
    ...
    $tercero = DB::table('tercero')
            ...
            ->leftJoin('tipoproveedor','TipoProveedor_idTipoProveedor','=','idTipoProveedor')
            ...
            ->select(DB::raw('idTercero, nombreTipoIdentificacion , documentoTercero, nombreCompletoTercero, estadoTercero,nombreTipoProveedor,fechaIngresoTerceroInformacion,nombreCentroCosto'))
            ->where('tercero.Compania_idCompania','=', \Session::get('idCompania'))
            ->where('tipoTercero', '=', '*02*')
    ...
    {  
        $row[$key][] = '<a href="tercero/'.$value->idTercero.'/edit?tipo='.'*02*'.'">'.
                            '<span class="glyphicon glyphicon-pencil" style = "display:'.$visibleM.'"></span>'.
                        '</a>&nbsp;'.
                        '<a href="tercero/'.$value->idTercero.'/edit?accion=eliminar&tipo='.'*02*'.'">'.
