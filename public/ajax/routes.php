...
Route::group(['middleware' => 'auth'], function () 
{
    ...
    Route::resource('grupoestadoetapagridselect','GrupoEstadoController@indexSelect');
...

{
   ...
   Route::get('datosDiagnostico2', function()
    ...
    Route::get('datosGrupoEstadoEtapaSelect', function()
    {
        include public_path().'/ajax/datosGrupoEstadoEtapaSelect.php';
    });
